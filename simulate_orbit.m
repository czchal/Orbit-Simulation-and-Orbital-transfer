...
% simulates a satellite trajectory in cartesian coordinate by solving the kepler's
% equation. 
...
while t<runtime
    ...
    %     ydot_vals(i)=sqrt(mu/p)*(e+cos(t_a(i)))
        ...
        positions(t+1,1:3)=position';
        velocities(t+1,1:3)=velocity';
